...
namespace LeaveManagement.web.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<Employee> _signInManager;//creates cookie
        private readonly UserManager<Employee> _userManager;//gives access to entire user library
        private readonly IUserStore<Employee> _userStore;//helping with claims and other 
        ...
        ///     directly from your code. This API may change or be removed in future releases.
        /// </summary>
        public IList<AuthenticationScheme> ExternalLogins { get; set; } //support google login, facebook login etc
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.CreateAsync(user, Input.Password);//hash and store the password
